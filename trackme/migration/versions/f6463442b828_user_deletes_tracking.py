...
def upgrade():
    ...
    op.alter_column("tracking", "created_at", existing_type=postgresql.TIMESTAMP(), nullable=True)
    op.alter_column("tracking", "user_id", existing_type=sa.INTEGER(), nullable=False)
    op.alter_column("tracking_attributes", "attribute_id", existing_type=sa.INTEGER(), nullable=True)
    op.alter_column("tracking_attributes", "tracking_id", existing_type=sa.INTEGER(), nullable=True)
...
def downgrade():
    ...
    op.alter_column("tracking_attributes", "tracking_id", existing_type=sa.INTEGER(), nullable=False)
    op.alter_column("tracking_attributes", "attribute_id", existing_type=sa.INTEGER(), nullable=False)
    op.alter_column("tracking", "user_id", existing_type=sa.INTEGER(), nullable=True)
    op.alter_column("tracking", "created_at", existing_type=postgresql.TIMESTAMP(), nullable=False)
    op.drop_constraint(None, "attributes", type_="foreignkey")
    op.drop_constraint(None, "attributes", type_="foreignkey")
    op.create_foreign_key("attributes_topic_id_fkey", "attributes", "topics", ["topic_id"], ["id"], ondelete="CASCADE")
    op.create_foreign_key("attributes_user_id_fkey", "attributes", "users", ["user_id"], ["id"], ondelete="CASCADE")
    # ### end Alembic commands ###
